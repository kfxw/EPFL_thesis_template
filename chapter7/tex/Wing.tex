...
\begin{figure}[ht!]
    ...
    \subfloat[Probability density plot]{%
        \includegraphics[width=0.7\textwidth]{chapter7/fig/probability_density_plot.pdf}%
        \label{ch7:subfig:wing_PDF}
    }\\[1em]
    \subfloat[Violin plot]{%
        \includegraphics[width=0.7\textwidth]{chapter7/fig/violin_plot_equal_area.pdf}%
